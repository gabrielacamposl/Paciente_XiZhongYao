...
import back from '../public/images/FrontXiZhongYao.gif';
import back1 from '../public/images/XiZhongYao2.png';
import back2 from '../public/images/XiZhongYao3.png';
        ...
        <div className="grid">
          ...
          <div className="col-12 md:col-4 mb-4 px-5">
            ...
            <div>
              ...
              <Button className=' p-button p-component font-bold p-button-outolined p-button-rounded  ' onClick={() => { router.push('/login') }}> Pruébalo</Button>
            </div>
        ...
        <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center ">
          <section>
            ...
            <div className=" text-700 text-center">
              ...
              <Button label="Ver nuestros especialistas en salud" icon="pi pi-shield" className="font-bold px-5 py-3 p-button-raised p-button-rounded white-space-nowrap"  onClick={() => { router.push('/login') }}  />
            </div>
            <h1 style={estiloTexto}>XiZhongYao</h1>
            <h1 style={estiloTexto}>XiZhongYao</h1>
            <h1 style={estiloTexto}>XiZhongYao</h1>
            ...
            <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center">
              <section>
                ...
                <div className="text-700 text-center">
                  ...
                  <Button label="Identifica tu planta ahora mismo" icon="pi pi-camera" className="font-bold px-5 py-3 p-button-raised p-button-rounded white-space-nowrap" onClick={() => { router.push('/login') }} />
                </div>
                <h1 style={estiloTexto}>XiZhongYao</h1>
                <h1 style={estiloTexto}>XiZhongYao</h1>
                <h1 style={estiloTexto}>XiZhongYao</h1>
