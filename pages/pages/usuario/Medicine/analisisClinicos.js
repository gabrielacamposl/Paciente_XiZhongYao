...
const AnalisisClinicos = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Redirigir a la página de resultados con los valores como parámetros de consulta
    router.push(`/pages/usuario/Medicine/analisisResult?${queryParams.toString()}`);
  };
      ...
      <div className="grid">
        <div className="col-12">
          ...
          <div className="flex align-items-center justify-content-center">
            <Link href={`/pages/usuario/Medicine/analisisResult?${queryParams.toString()}`} passHref>
              <Button as="a" label="Interpretar Análisis" />
            </Link>
          </div>
          {error && (
