...
const Cards = () => {
  ...
  const [rows, setRows] = useState([
    ...
    { nombre: "Terminación: ", terminacion: 9197, tipo: "MasterCard" },
  ...
  return (
    <Layout title="Tarjetas" description="Mi Cuenta"><div className="grid">
    <div className="col-12">
      <div className="card">
        <h3>Tarjetas Guardadas</h3>
        <div className=''>
          <div className='field'>
            <Link href="/pages/usuario/PerfilUser/perfil" className="font-medium no-underline ml-2 text-right cursor-pointer" style={{ color: 'var(--primary-color)' }}>
              Regresar
            </Link>
          </div>
        </div>
